...
class TraverseRebangPage(unittest.TestCase):
	...
	def goIntoPage(self):	
		...
		self.driver.find_element_by_id('com.yixia.videoeditor:id/bottom_friend').click()
		sleep(2)
	...
	def test_traverse_rebang_page(self):
...
def suite(self):
	...
	suite.addTest(TraverseRebangPage('test_traverse_rebang_page'))
